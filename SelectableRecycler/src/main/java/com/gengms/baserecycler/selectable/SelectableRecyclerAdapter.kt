...
import com.gengms.baserecycler.BaseRecyclerAdapter
import com.gengms.baserecycler.BaseViewHolder
import com.gengms.baserecycler.OnItemClickListener
import com.gengms.baserecycler.OnItemLongClickListener
...
) : BaseRecyclerAdapter<Selectable<T>>(context,
    newSelectableList(dataList)
),
    OnItemLongClickListener,
    OnItemClickListener {
    private var selectState: SelectState =
        SelectState.DOING
